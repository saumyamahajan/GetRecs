...
def movie_page():
    ...
    #MovieRec
    st.title('Get recommendations for your favourite movies')
    selected_movie_name = st.selectbox('Type or select a movie from the dropdown', movies_list['title'].values)
